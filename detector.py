...
#     cv2.imwrite('static/Image.jpg', res)
#     return predicted_class  # , {classes[i]: float(confidences[i]) for i in range(len(confidences))}
#
#
# # image = gr.inputs.Image()
# # image1 = gr.outputs.Image()
# # label = gr.outputs.Label()
# # #
# # gr.Interface(fn=predict, inputs=image, outputs=[image1], capture_session=True).launch()
#
# predict(None)
